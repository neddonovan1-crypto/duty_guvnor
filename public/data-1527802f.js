  ...
  return {
    "cards": [
      ...
      },
      {
        ...
        "text": "An envelope left at the wicket by somebody who did not wait to be thanked: heavy paper, no crest, one sheet in a very old-fashioned hand.\n\n'Sir — I am told one does not write to a police station, and I find I do not care. You had it in your power to finish a man on a Tuesday and you declined to, and you did not make me thank you for it at the time, which was the greater part of the kindness. I shall not name the matter and I am confident you never will. Should your station ever need a door opened, or a word said in a room you cannot get into, you have only to ask. — A. F.'\n\nNo address. A telephone number in pencil, and Sgt Bream — who read the whole thing over your shoulder without a flicker of apology — has already committed it to memory.",
        "tone": "weary",
    ...
    "quietTurns": [
      ...
      "Half an hour of nothing, into which PC Whittle drops his theory that Cell Three is haunted — a sergeant, he's heard, from before the war, still doing his rounds. The relief scoff and thereafter go down to the cells in pairs. Regan the station cat won't go at all, which clinches it.",
        ...
        "stages": [
          {
            ...
            "text": "Sergeant Maddocks of the Welsh Guards, Wellington Barracks, in the flat voice of a {man} trying the civil police before he tries his own Provost. The battalion flies to Cyprus on Thursday. Guardsman Prosser, nineteen, did not answer at last post, and his boots are gone from under his bed.\n\nMaddocks is not ringing because the boy is lost. He is ringing because he knows exactly where he is: his mother's flat, four streets from this nick, two sisters and a settee. A Provost van at that door at four in the morning is a thing a street remembers for twenty years. Back through the gate by seven and it is jankers and a seat on Thursday's aircraft; booked by the police and it is a court martial — Colchester instead of Cyprus, which is not the improvement it sounds.",
            "choices": [
              {
          ...
          },
          {
            ...
            "text": "Prosser has been in the front office for forty minutes, drinking tea he holds in both hands and answering everything with 'sir' in a voice that has not finished breaking. He has volunteered one thing, to nobody in particular: he doesn't mind the Army, he minds Cyprus, and a mate's brother came back off that island last year and is not right.\n\nThen a car that has no business on this manor stops outside, and Captain the Hon. Rollo Anstruther-Vane comes through the door in a British Warm, carrying gloves he does not put down. He is twenty-six and speaks as though the room were further away than it is. He would like to take the boy now; he would like the occurrence book to contain nothing whatever; and he mentions, in the same pleasant breath, that his father shoots with the Home Secretary. Behind him in the doorway stands Sergeant Maddocks, twenty-two years in, looking at the floor.",
            "choices": [
              {
